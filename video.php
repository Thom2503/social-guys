<?php
  ...
  $viewAdd = "INSERT INTO `views`(`VideoID`, `KanaalID`) VALUES ('$id', '$kID')";
  mysqli_query($conn, $viewAdd);
  ...
  if ($result)
  {
    ...
    foreach($resultaat as $kanaal)
    {
      ...
      <a href='kanaal.php?id=". $kanaal['Kanaal_ID'] ."'><img class='img-fluid ml-1 rounded-circle' style='width: 70px; height: 70px;' src='uploads/".$kanaal['ProfielPhoto']."' alt='Profilephoto for this channel'></a>
